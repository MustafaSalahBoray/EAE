 ...
 <?php require 'Nav.php';?>
    ...
    <div class="d-flex main">
                ...
                <ul class="p-0  list-unstyled mt-3 d-inline flex-column">
                    ...
                    <li>
                        <a  href="http://localhost/EAE/InsertDegisnation.php" class="d-inline align-items-center  py-3  text-decoration-none" type="button"
                            >
                            <i class="fa-solid fa-book-open-reader list-icon fa-fw fw-bold here "></i>
                            <span class="list-text fw-bold here">Insert Degisnation</span>
                        </a>
                    </li>
        ...
        <section class="container-fluid  ps-4">
          ...
          <h1 class="text-center ml-5">Insert Department</h1>
        ...
        <form method="POST" class="bg-secondary ">
            ...
            <label for="subject" class="form-label subject fw-bold"class="text-primary">Insert Department</label>
             <input type="text" class="form-control" id="formGroupExampleInput" name="Department" placeholder="Enter Department">
      ...
      <?php 
            ...
            if(isset($_POST['submit'])){
              ...
              $Insert=$db->prepare("INSERT INTO department (Department ) VALUES (:Department )");
                  $Insert->bindparam("Department",$_POST['Department']);
                  $Insert->execute();
